...
function CountUp({
  ...
  const formatted = formatComma ? value.toLocaleString("en-US") : String(value);
  return (
    <span>
      {prefix}
      {formatted}
...
const SLIDES: Slide[] = [
  ...
  {
    id: "hero",
    eyebrow: "◆ Hech kim aytmaydigan haqiqat",
    render: () => (
      <>
        ...
        >
          Har oy minglab ota-onalar Google&apos;da &ldquo;Toshkentda IELTS&rdquo;,
          &ldquo;dasturlash kursi&rdquo;, &ldquo;ingliz tili&rdquo; deb qidirishyapti.
          Ular sizni emas, raqobatchingizni topishyapti.
        </p>
      </>
    ),
  },
        ...
        {[
          {
            ...
            l: "Oylik kurs qidiruvlari",
            d: "Real Google qidiruv hajmi &mdash; yildan-yilga oshib bormoqda.",
            delay: 0.05,
          },
          {
            big: <CountUp end={93} suffix="%" duration={1500} delay={250} />,
            l: "Sharhlardan ta'sirlanadi",
            d: "BrightLocal 2025: mijoz tanlovda onlayn sharhlardan ta'sirlanadi.",
            delay: 0.25,
          },
          {
            big: <span>1-4 hafta</span>,
            l: "Google'da paydo bo'lasiz",
            d: "Yangi sayt SEO qurish 3-6 oy. Darslinker'da &mdash; 1-4 hafta.",
            delay: 0.45,
          },
        ].map((s, i) => (
    ...
    render: () => (
      <>
        <h2 className="text-[32px] sm:text-[48px] md:text-[72px] font-bold leading-[1.05] tracking-[-0.03em] max-w-[1000px]">
          ...
          <span className="anim-fade-up inline-block" style={{ animationDelay: "2.1s" }}>
            &nbsp;topiladi.
          </span>
        </h2>
        <p
        ...
        >
          Sayt qurib Google&apos;da topga chiqish &mdash; 3-6 oy va katta xarajat. Reklamaga
          har oy yangi sarmoya. Darslinker esa bugun sizni mijozlarga ko&apos;rsatadi.
        </p>
      </>
    ),
  },
  {
    ...
    render: () => <VerbSlide word="Qidirilasiz." body="Domen tayyor, schema markup tayyor, SEO tayyor. Siz faqat profil to'ldirasiz — Google sizni ko'radi." />,
  },
  {
    id: "verb-2",
    eyebrow: "Darslinker · 2 / 3",
    render: () => <VerbSlide word="Topilasiz." body="Filtrlar: yo'nalish, hudud, narx, format. O'quvchi aniq sizning kursingizgacha boradi." />,
  },
  {
    id: "verb-3",
    eyebrow: "Darslinker · 3 / 3",
    render: () => <VerbSlide word="Bog'lanasiz." body="Lid CRM'ga tushadi, Telegram'ga real-time keladi, telefon raqam ko'rinadi." />,
  },
  {
    id: "pricing",
    eyebrow: (
      <>
        Darslinker<span className="text-white/40">ga qo&apos;shilish</span>
      </>
    ),
    render: () => <PricingSlide />,
  },
  {
    ...
    render: () => (
      <>
        ...
        >
          Ariza qoldirasiz, 24 soat ichida menejer aloqaga chiqadi. Profil 1 kunda tayyor.
          Birinchi lidlar 1-4 hafta ichida.
        </p>
...
const PRICING_FEATURES = [
  "Profil va cheksiz kurslar",
  "Google'da to'liq indeksatsiya",
  "AI tavsiyalarida ko'rinish",
  "CRM kabinet + Telegram bot",
  "Real-time lid + telefon raqam",
  "Reyting, sharh, statistika",
];
  ...
  return (
    <div className="max-w-[1100px] w-full">
      ...
      <p className="anim-fade-up text-[13px] md:text-[16px] text-white/45 mt-2 md:mt-3" style={{ animationDelay: "0.2s" }}>
        Bir xil imkoniyatlar, har xil muddat.
      </p>
      <div className="grid grid-cols-2 gap-6 sm:gap-10 md:gap-20 mt-8 md:mt-14">
        <div className="anim-fade-up" style={{ animationDelay: "0.35s" }}>
          <div className="text-[10px] md:text-[12px] font-semibold uppercase tracking-[0.2em] text-white/40">3 oy</div>
        ...
        <div className="anim-fade-up relative" style={{ animationDelay: "0.55s" }}>
          ...
          <div className="text-[10px] md:text-[12px] font-semibold uppercase tracking-[0.2em] text-[#7ea2d4]">6 oy</div>
          <div className="text-[48px] sm:text-[72px] md:text-[112px] font-bold mt-2 leading-none tracking-[-0.04em] tabular-nums text-[#7ea2d4]">
            $300
          </div>
          <div className="text-[12px] md:text-[14px] text-[#fbbf24] mt-2 md:mt-3 tabular-nums font-medium opacity-50">25% chegirma</div>
        </div>
      </div>
