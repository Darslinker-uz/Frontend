    ...
    <div className="px-3 sm:px-5 md:px-8 py-6 md:py-8 pb-24 md:pb-8">
      ...
      {loading ? (
        ...
        <div className="rounded-[14px] border border-dashed p-8 text-center" style={{ borderColor: config.surfaceBorder }}>
          ...
          <Link href="/dashboard/listings/new" className="inline-block h-[36px] px-4 rounded-[10px] text-[13px] font-medium leading-[36px]" style={{ backgroundColor: config.accent, color: config.accentText }}>
