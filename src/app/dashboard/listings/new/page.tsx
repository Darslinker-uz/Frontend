...
export default function NewListingPage() {
  ...
  const submit = async () => {
    ...
    if (!category) { setError("Kategoriyani tanlang"); return; }
        ...
        <div style={style} className={`relative overflow-hidden rounded-[24px] bg-gradient-to-br ${gradient.value} w-full`}>
          ...
          <div className="relative z-[2] p-5 pt-6 flex flex-col h-full">
            <div className="flex flex-wrap items-center gap-1.5 mb-4">
              <span className="inline-flex items-center px-2.5 py-1 rounded-full bg-white/20 text-white text-[11px] font-semibold backdrop-blur-sm">{category || "Kategoriya"}</span>
        ...
        <div style={style} className={`relative overflow-hidden rounded-[22px] bg-gradient-to-br ${gradient.value} flex flex-col w-full`}>
          ...
          <div className="relative z-[2] p-6 md:p-7 flex-1 flex flex-col">
            <div className="flex items-center gap-2 mb-5">
              <span className="px-3 py-1 rounded-full bg-white/20 text-white text-[12px] font-semibold">{category || "Kategoriya"}</span>
    ...
    <div className="px-3 sm:px-5 md:px-8 py-6 md:py-8 pb-24 md:pb-8">
      ...
      <div className="space-y-5">
        ...
        <div className="rounded-[16px] p-4 sm:p-5 space-y-4" style={{ backgroundColor: config.surface, border: `1px solid ${config.surfaceBorder}` }}>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className={labelClass} style={labelStyle}>O&apos;quvchilar limiti</label>
              <input type="number" placeholder="20" className={inputClass} style={inputStyle} />
            </div>
            <div>
        ...
        <div className="rounded-[16px] p-4 sm:p-5 space-y-4" style={{ backgroundColor: config.surface, border: `1px solid ${config.surfaceBorder}` }}>
          ...
          <div>
            ...
            <input placeholder="Ism familiya" className={inputClass} style={inputStyle} />
          </div>
          <div>
            <label className={labelClass} style={labelStyle}>Tajriba</label>
            <textarea placeholder="5 yillik tajriba, Google sertifikati..." className={textareaClass} style={inputStyle} rows={3} />
          </div>
        </div>
        ...
        <div className="rounded-[16px] p-4 sm:p-5 space-y-4" style={{ backgroundColor: config.surface, border: `1px solid ${config.surfaceBorder}` }}>
          ...
          <div>
            ...
            <input placeholder="Birinchi oy 50% chegirma" className={inputClass} style={inputStyle} />
          </div>
        </div>
