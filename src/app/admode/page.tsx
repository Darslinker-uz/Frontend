...
export default function AdmodePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Full navigation so the new session cookie is picked up by middleware on /admode
      ...
      <div className="w-full max-w-[400px]">
        ...
        <div className="rounded-[20px] p-6 md:p-8" style={{ backgroundColor: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)" }}>
          ...
          <p className="text-[11px] text-white/30 text-center mt-5">
            O&apos;quv markaz: <a href="/center" className="text-[#7ea2d4] hover:underline">/center</a>
            {" · "}
            O&apos;quvchi: <a href="/student" className="text-[#7ea2d4] hover:underline">/student</a>
          </p>
        </div>
      </div>
    </div>
