    ...
    try {
      ...
      const res = await fetch("/api/admin/listings", {
        ...
        body: JSON.stringify({
          ...
          // Eski formatdagi bitta region/district — birinchi filialdan (backward compat)
          region: firstBranch?.region || null,
          district: firstBranch?.district || null,
          // Yangi: barcha filiallar massiv ko'rinishida
          ...
          phone: hasUzPhoneContent(contactPhone) ? contactPhone.trim() : (selectedProvider?.phone || ""),
        ...
        <div style={style} className={`relative overflow-hidden rounded-[24px] bg-gradient-to-br ${gradient.value} w-full`}>
          {imageUrl ? (
            <>
              ...
              <div className="absolute inset-0" style={{ backgroundColor: `rgba(0,0,0,${imageDarkness/100})` }} />
