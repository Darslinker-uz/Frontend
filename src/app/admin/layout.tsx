...
const navItems = [
  ...
  { href: "/admin/listings", label: "E'lonlar", icon: FileText },
  { href: "/admin/leads", label: "Leadlar", icon: MessageSquare },
  { href: "/admin/payments", label: "To'lovlar", icon: CreditCard },
  { href: "/admin/boosts", label: "Boostlar", icon: Zap },
...
function AdminShell({ children }: { children: React.ReactNode }) {
  ...
  // Auth page — render without admin shell (no sidebar, no mobile navs)
